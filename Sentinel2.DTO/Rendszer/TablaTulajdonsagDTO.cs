...
{
    [Serializable]
    public class TablaTulajdonsagDTO : BaseDTO
    {
    ...
    [Serializable]
    public class TablaTulajdonsagKeresoDTO : TablaTulajdonsagDTO
    {
        ...
        private string _TablaIDs = null;

        public string TablaIDs
        {
            get { return _TablaIDs; }
            set { _TablaIDs = value; }
        }
